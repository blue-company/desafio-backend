...
export const createConsultationPDF = async (user_id: number, username: string, doctorName: string, consultationTime: string, consultationDate: string, speciality: string) => {
    return await generatePDF({ user_id, username, doctorName, consultationTime, consultationDate, speciality })
}

export const getConsultations = async (user_id: number | undefined) => {
    if (user_id) {
...
export const scheduleConsultation = async (data: ScheduleConsultation, user_id: number | undefined, username: string | undefined) => {
    if (user_id && username) {
...
export const updateConsultation = async (id: number, user_id: number | undefined, username: string | undefined, data: UpdateConsultationData) => {
    if (user_id && username) {
...
export const cancelConsultation = async (id: number, user_id: number | undefined) => {
    if (user_id) {
