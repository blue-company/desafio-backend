...
import { scheduleConsultationController, getConsultationsController, getConsultationController, updateConsultationController, cancelConsultationController, getDoctorsController } from "../controllers/ApiController";
